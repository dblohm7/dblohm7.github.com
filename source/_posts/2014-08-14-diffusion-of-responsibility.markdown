...
The reaction to roc's [recent blog post](https://robert.ocallahan.org/2014/08/choose-firefox-now-or-later-you-wont.html) 
...
especially [Nightly](https://nightly.mozilla.org) builds. This allows us to do 
...
reports [data](https://crash-stats.mozilla.com/home/product/Firefox) about the 
crash. We have Firefox Health Report and [Telemetry](https://telemetry.mozilla.org) 
...
is to include data that has been generated by the [Gecko Profiler](https://developer.mozilla.org/en-US/docs/Mozilla/Performance/Reporting_a_Performance_Problem). 
...
As you can see in our [crash report data](https://crash-stats.mozilla.com/home/product/Firefox),
...
I'd suggest reporting your problem over at [webcompat.com](https://webcompat.com). 
